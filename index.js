function Question(questionText){
  ...
  let q1 = new Question("1. Javascript Supports");
  let q2 = new Question("2. Which language is used for styling web pages");
  let q3 = new Question("3. Which is not a JS framework");
  let q4 = new Question("4. Which is used for Connect To Database?");
  let q5 = new Question("5. JavaScript is a");
  ...
  function Quiz(qaPairArray){
    ...
    this.displayFinalScorePage = function(){
      ...
      `<h1>Result</h1>
      <p id='question'>Your scores ${scores}. <br> Mark Percentage is ${percentage}%;
      `;
